...
@section('content')
<div class="container" style="margin-left:25%;margin-top:8%;" >
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right" style="font-size:25px;">Contraseña</label>
